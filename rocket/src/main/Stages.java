...
public class Stages {
    ...
    protected Double M1 = 2_145_000.0; // Полная масса первой ступени, кг
    protected Double M1e = 130_000.0; // Масса в конце работы первой ступени, кг
    protected Double M2 = 480_000.0; // Полная масса второй ступени, кг
    protected Double M2e = 37_000.0; // Масса в конце работы блока второй ступени, кг
    protected Double M3 = 122_500.0; // Полная масса третьей ступени, кг
    protected Double M3e = 100_000.0; // Масса в конце работы блока третьей ступени, кг
    protected Double M4 = 48_000.0; // Полная масса командного модуля

    protected Double M4e = 18_500.0; // Масса командного модуля в конце работы

    protected Double Mk = 15_000.0; //Масса лунного модуля
    ...
    protected void printParameters() {
        System.out.println("M = " + (M0 + M1 + M2 + M3 + Mk + M4));
        System.out.println("M1234 = " + (M1 + M2 + M3 + M4));
