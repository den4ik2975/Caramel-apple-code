...
public class StageThree extends Stages {
    ...
    public StageThree() {
        t = 150.0; // Время работы третьей ступени, с
        F = 3_500_000.0; // Тяга двигателя третьей ступени, Н
        M = M3 + Mk + M4; // Масса ракеты с космическим кораблём после отделения второй ступени, кг
